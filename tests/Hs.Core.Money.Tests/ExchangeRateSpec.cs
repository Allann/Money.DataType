...
using Xunit;
using Hs.Core.Money.Tests.Helpers;

namespace Hs.Core.Money.Tests.ExchangeRateSpec
{
    public class GivenIWantToConvertMoney
    {
        ...
        public void WhenConvertingEurosToDollars_ThenConversionShouldBeCorrect()
        {
            ...
            var converted = _exchangeRate.Convert(Amount.Euro(100.99M));

            converted.Currency.Should().Be(_dollar);
            converted.Value.Should().Be(127.16M);
        }
        ...
        public void WhenConvertingEurosToDollarsAndThenBack_ThenEndResultShouldBeTheSameAsInTheBeginning()
        {
            ...
            revert.Value.Should().Be(100.99M);
        }
        ...
        {
            // Arrange, Act
            Action action = () => _exchangeRate.Convert(Amount.Yen(324));
